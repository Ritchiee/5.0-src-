...
public class English extends Language {
	...
	public English() {
		...
		addTranslatedMessage(CustomMessageId.SPREE4, "Rampage");
		addTranslatedMessage(CustomMessageId.SPREE5, "Dominating");
		addTranslatedMessage(CustomMessageId.SPREE6, "Unstoppable");
		addTranslatedMessage(CustomMessageId.SPREE7, "InsaneMonster");
		addTranslatedMessage(CustomMessageId.SPREE8, "Godlike");
		addTranslatedMessage(CustomMessageId.SPREE9, "WickedSick");
		addTranslatedMessage(CustomMessageId.SPREE10, "Muthafakaaas");
		...
		addTranslatedMessage(CustomMessageId.MSG_SPREE4, " is now on a ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE4_1, " !");
		addTranslatedMessage(CustomMessageId.MSG_SPREE5, " is now ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE5_1, " !");   
		addTranslatedMessage(CustomMessageId.MSG_SPREE6, " is ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE6_1, " ! Run away if you can!");
		addTranslatedMessage(CustomMessageId.MSG_SPREE7, " is a ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE7_1, " !");
		addTranslatedMessage(CustomMessageId.MSG_SPREE8, " is now ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE8_1, " !");
		addTranslatedMessage(CustomMessageId.MSG_SPREE9, " is now on ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE9_1, " !");   
		addTranslatedMessage(CustomMessageId.MSG_SPREE10, " CHUUCHUU ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE10_1, " ! IS NOW A TRUE PVP FIGHTER!!!!!!!");
		...
		addTranslatedMessage(CustomMessageId.SPREE_MONSTER_MSG, "a insane player");
	}
}