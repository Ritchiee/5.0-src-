    ...
    public PlayerAppearance load(final int playerId) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                pa.setEyeRGBLeft(resultSet.getInt("eye_rgb"));
                ...
                pa.setEyeRGBRight(resultSet.getInt("eye_rgb_right"));
                pa.setEyeLashes(resultSet.getInt("eye_lash"));
                pa.setPupilSize(resultSet.getInt("pupil_size"));
                pa.setUpperTorso(resultSet.getInt("upper_torso"));
                pa.setForeArmThick(resultSet.getInt("forearm_thickness"));
                pa.setHandSpan(resultSet.getInt("hand_span"));
                pa.setCalfThick(resultSet.getInt("calf_thickness"));
                pa.setRemoveMane(resultSet.getInt("no_mane"));
        ...
        return DB
                .insertUpdate(
                        "REPLACE INTO player_appearance ("
                                ...
                                + "leg_thickness, leg_length, foot_size, facial_rate, voice, height, pupil_shape,eye_rgb_right,eye_lash,pupil_size,upper_torso,forearm_thickness,hand_span,calf_thickness,no_mane)" + " VALUES "
                                + "(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,"
                                + "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?" + ")", new IUStH() {
                            @Override
                            public void handleInsertUpdate(PreparedStatement ps) throws SQLException {
                                ...
                                ps.setInt(55, pa.getPupilShape());
                                ps.setInt(56, pa.getEyeRGBRight());
                                ps.setInt(57, pa.getEyeLashes());
                                ps.setInt(58, pa.getPupilSize());
                                ps.setInt(59, pa.getUpperTorso());
                                ps.setInt(60, pa.getForeArmThick());
                                ps.setInt(61, pa.getHandSpan());
                                ps.setInt(62, pa.getCalfThick());
                                ps.setInt(63, pa.getremoveMane());
                                ps.execute();
                            }
                        });
    }
