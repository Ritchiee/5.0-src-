...
public enum CustomMessageId {
	...
	HOMEPAGE("Homepage:www.insaneaion.com"),
	TEAMSPEAK("Teamspeak3:ts3.insaneaion.com"),
    ...
    INFO6("Help: use the command: .help to see other available player commands"),
    ...
    /**
     * PvP Spree Service Put in English
     */
    SPREE1("Bloody Storm"),
    SPREE2("Carnage"),
    SPREE3("Genocide"),
    ...
    SPREE5("Dominating"),
    SPREE6("Unstoppable"),
    SPREE7("InsaneMonster"), 
    SPREE8("Godlike"),
    SPREE9("WickedSick"),
    SPREE10("Muthafakaaas"),   
    ...
    MSG_SPREE3_1(" ! Watch Out !"),
    MSG_SPREE4(" is now on a "),
    MSG_SPREE4_1(" !"),
    MSG_SPREE5(" is now "),
    MSG_SPREE5_1(" !"),    
    MSG_SPREE6(" is "),
    MSG_SPREE6_1(" ! Run away if you can!"),
    MSG_SPREE7(" is a "),
    MSG_SPREE7_1(" !"),
    MSG_SPREE8(" is now "),
    MSG_SPREE8_1(" !"),
    MSG_SPREE9(" is now on "),
    MSG_SPREE9_1(" !"),   
    MSG_SPREE10(" CHUUCHUU "),
    MSG_SPREE10_1(" ! IS NOW A TRUE PVP FIGHTER!!!!!!!"),
    ...
    SPREE_MONSTER_MSG("a insane player");
