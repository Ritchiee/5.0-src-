...
public class StaticData {
    ...
    public PlayerCpTable playerCpTable;
    ...
    private void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
		...
		DataManager.log.info("Loaded " + skillEnchantData.size() + " skill enchant entries");
        DataManager.log.info("Loaded " + playerCpTable.size() + " player cp table entries");
