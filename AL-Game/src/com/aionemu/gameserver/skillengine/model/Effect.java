...
public class Effect implements StatOwner {
	...
	public boolean isEmbark(int skillId) {
		switch (skillId) {
			case 2767: // Embark
			case 2768:
			case 2769:
    ...
    private void endRiderEffect(){
        int[] riderEffect = {2440, 2441, 2442, 2443, 2444, 2445, 2446, 2447, 2448, 2449, 2579, 2580, 2581, 2421, 2422, 2736, 2737, 2738, 2739, 2740, 2838, 2839, 2840, 2841, 2842, 2843, 2844, 2845, 2846, 2847, 2848};

        if (effector instanceof Player){
            Player player = (Player) effector;

                for (int skillId : riderEffect){
                    if (player.getEffectController().isNoshowPresentBySkillId(skillId)){
                        player.getEffectController().removeNoshowEffect(skillId);
                        PacketSendUtility.sendPacket((Player) effector, new SM_SKILL_ACTIVATION(skillId, false));
                    }    
                }
        	}
    	}
