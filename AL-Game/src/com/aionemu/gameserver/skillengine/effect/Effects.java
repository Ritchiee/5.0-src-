...
public class Effects {
    ...
    @XmlElements({
            ...
            @XmlElement(name = "dummyeffect", type = DummyEffect.class),
            @XmlElement(name = "supportevent", type = SupportEventEffect.class),
            ...
            @XmlElement(name = "healxp", type = HealExpEffect.class)
    })
