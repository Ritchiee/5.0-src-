...
public class SwitchHpMpEffect extends EffectTemplate {
    ...
    public void applyEffect(Effect effect) {
        ...
        int maxMP = lifeStats.getMaxMp();
        int reverseHp = 10;

        if (currentHp < currentMp){
        	lifeStats.setCurrentMp(currentMp + currentHp);
        	reverseHp = maxMP - currentMp;
        	if (currentHp <= reverseHp){
        		lifeStats.setCurrentHp(10);
        	}else{
        		lifeStats.setCurrentHp(reverseHp);
        	}
        }else{
