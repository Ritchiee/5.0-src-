        ...
        switch (value) {
            ...
            case AREA:
                ...
                for (VisibleObject nextCreature : firstTarget.getKnownList().getKnownObjects().values()) {
                    ...
                    {
                        if (MathUtil.isInsideAttackCylinder(skill.getEffector(), nextCreature, properties.getEffectiveDist(), properties.getEffectiveRange(),
                               properties.getDirection()))//(MathUtil.isInsideAttackCylinder(skill.getEffector(), nextCreature, distanceToTarget, properties.getEffectiveDist(),properties.getDirection()))
                        {
