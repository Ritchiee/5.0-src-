...
public class CustomConfig {
     ...
     * Item Rewards
     */
    @Property(key = "gameserver.item.reward1", defaultValue = "166020000")
    public static int REWARD1;
    @Property(key = "gameserver.item.reward2", defaultValue = "166030005")
    ...
    /**
 	 * EVENT FUNCTIONS 
 	 */
    @Property(key = "gameserver.efunctions.enable", defaultValue = "true")
	public static boolean EFUNCTIONS_ENABLE;
    
    /**
  	 * Recharger Portal 
  	 */
     @Property(key = "gameserver.recharger.portal.enable", defaultValue = "true")
 	public static boolean RECHARGER_PORTAL_ENABLE;
     
     @Property(key="gameserver.powerflight.costfp", defaultValue="16")
     public static int POWERFLIGHT_COSTFP;
     
     @Property(key="gameserver.powerflight.flyspeed", defaultValue="16")
     public static int POWERFLIGHT_FLYSPEED;
     
     @Property(key = "gameserver.disable.rank.equipment", defaultValue = "false")
     public static boolean DISABLE_RANK_EQUIPMENT;
     
     @Property(key = "gameserver.enchat.always.success", defaultValue = "false")
