...
public class EnchantsConfig {
     ...
     */
	@Property(key="gameserver.enable.cap.enchantment", defaultValue="false")
	 public static boolean ENABLE_CAP_ENCHANTMENT;
	...
	@Property(key = "gameserver.amplified.max.type1", defaultValue = "20")
    public static int AMPLIFIED_MAX_LEVEL_TYPE1; 
    @Property(key = "gameserver.amplified.max.type2", defaultValue = "25")
    public static int AMPLIFIED_MAX_LEVEL_TYPE2; 
    @Property(key = "gameserver.charged.stigma.max", defaultValue = "5")
    public static int MAX_CHARGED_STIGMA; 
    @Property(key = "gameserver.charged.stigma.success.rate", defaultValue = "25")
    public static int CHARGED_STIGMA_SUCCESS_RATE; 
}
