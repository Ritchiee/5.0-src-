...
public class CM_CREATE_CHARACTER extends AionClientPacket {
    ...
    protected void readImpl() {
        ...
        playerAppearance.setEyeRGBLeft(readD());
        ...
        playerAppearance.setEyeRGBRight(readD());
        playerAppearance.setEyeLashes(readC());
        readC();
        ...
        playerAppearance.setForeArmThick(readC());
        playerAppearance.setHandSpan(readC());
        playerAppearance.setCalfThick(readC());
        readC();
        readC();
        readC();
