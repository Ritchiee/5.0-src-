...
public class CM_EMOTION extends AionClientPacket {
    ...
    protected void readImpl() {
        ...
        switch (emotionType) {
            ...
            case START_SPRINT:
            case END_SPRINT:
            case START_POWERFLIGHT:
            case END_POWERFLIGHT:
    ...
    protected void runImpl() {
        ...
        switch (emotionType) {
            ...
            case START_POWERFLIGHT:
                ...
                int wingSoaringCostFp = 0;
                if (wingsEquip != null) {
                	wingSoaringCostFp = wingsEquip.getItemTemplate().getWingStats().getSoaringCostFp();
                }
            
	            player.setPowerFlight(true);
	            player.getLifeStats().triggerFpReduceByCost(wingSoaringCostFp + CustomConfig.POWERFLIGHT_COSTFP);
	            break;
            case END_POWERFLIGHT:
            	if (!player.isInPowerFlight()) {
                    return;
                }
                player.setPowerFlight(false);
                break;
            default:
                break;
        }
