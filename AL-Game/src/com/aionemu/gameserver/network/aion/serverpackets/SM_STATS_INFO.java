...
public class SM_STATS_INFO extends AionServerPacket {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        writeH(0); //TODO essence Power
        writeH(0); //TODO essence Health
        writeH(0); //TODO essence Agi
        writeH(0); //TODO essence Precision
        writeH(0); //TODO essence KNowlede
        writeH(0); //TODO essence Will

        writeD((int) pcd.getCurrentEventExp());
