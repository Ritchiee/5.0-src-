...
public class SM_PLAYER_INFO extends AionServerPacket {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        if (player.getClientConnection() != null) {
            ...
            // * = Wedding
            if (player.isMarried()) {
             String partner = ((PlayerDAO)DAOManager.getDAO(PlayerDAO.class)).getPlayerNameByObjId(this.player.getPartnerId());
        ...
        if (player.isLegionMember() && !player.isInFFA() && !player.isInArena() && !player.isInDuoFFA()) {
        ...
        for (Item item : items) {
            if (player.isInFFA() || player.isInDuoFFA() ||  player.isInArena()){
                writeD(PVPManager.getDisplayTemplate(player, item));
        ...
        writeD(playerAppearance.getEyeRGBLeft());
        ...
        writeD(playerAppearance.getEyeRGBRight());
        writeC(playerAppearance.getEyeLashes());
        ...
        writeC(playerAppearance.getForeArmThick());
        writeC(playerAppearance.getHandSpan());
        writeC(playerAppearance.getCalfThick());
