...
import com.aionemu.gameserver.services.abyss.AbyssPointsService.AddAPGlobalCallback;

/**
 * @author Ever
 */
public class GloryPointsListener extends AddAPGlobalCallback {
	...
	@Override
	public void onAbyssPointsAdded(Player player, int gloryPoints) {
