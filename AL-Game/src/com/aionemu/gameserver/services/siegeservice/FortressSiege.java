                ...
                if (player.getRace().name() == race.name()) {//dont know if this works...
                    switch (player.getAbyssRank().getRank()) {
                        case SUPREME_COMMANDER:
                            AbyssPointsService.addAGp(player, 0, -300);
                            break;
                        case COMMANDER:
                            AbyssPointsService.addAGp(player, 0, -250);
                            break;
                        case GREAT_GENERAL:
                            AbyssPointsService.addAGp(player, 0, -200);
                            break;
                        case GENERAL:
                            AbyssPointsService.addAGp(player, 0, -150);
                            break;
                        case STAR5_OFFICER:
                            AbyssPointsService.addAGp(player, 0, -100);
                            break;
                        case STAR4_OFFICER:
                            AbyssPointsService.addAGp(player, 0, -50);
                            break;
                        case STAR3_OFFICER:
                            AbyssPointsService.addAGp(player, 0, -25);
                            break;
                        case STAR2_OFFICER:
                            AbyssPointsService.addAGp(player, 0, -20);
                            break;
                        case STAR1_OFFICER:
                            AbyssPointsService.addAGp(player, 0, -10);
                            break;
                        default:
                            break;
                    }
            ...
            for (int rewardedPC = 0; i < topPlayersIds.size() && rewardedPC < topGrade.getTop(); ++i) {
                ...
                switch (level) {//gp reward for fotress occupation
                    case HERO_DECORATION:
                        AbyssPointsService.addAGp(pcd.getPlayer(), 0, 300);
                        break;
                    case MEDAL:
                        AbyssPointsService.addAGp(pcd.getPlayer(), 0, 200);
                        break;
                    case ELITE_SOLDIER:
                        AbyssPointsService.addAGp(pcd.getPlayer(), 0, 150);
                        break;
                    case VETERAN_SOLDIER:
                        AbyssPointsService.addAGp(pcd.getPlayer(), 0, 100);
                        break;
                    default:
                        AbyssPointsService.addAGp(pcd.getPlayer(), 0, 50);
                        break;
                }
            }
        }
