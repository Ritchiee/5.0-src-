	...
	private void startChecker() {
		CronService.getInstance().schedule(new Runnable() {
            ...
            public void run() {
            	...
            	portalSpawns.put(831592, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(110010000, 831592, 1416f, 1264f, 336.66006f, (byte) 10), 1));//Portal
            	...
            	portalSpawns.put(831592, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(120010000, 831592, 1344f, 1419f, 208.125f, (byte) 57), 1));//Portal
            	portalSpawns.put(831592, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(110010000, 831592, 1816f, 1953f, 199.19724f, (byte) 10), 1));//Portal
            	
            	log.info("[Live Party] Entrance spawned in capital city's...");
            	prepareConcert();
