...
public class Player extends Creature {
    ...
    private int specialKills; // killspree counter
    ...
    //This variables are for the 1 vs 1 system
    ...
    //This variables are for the Invasion Rift system
    private boolean isInInvasionRift = false;
    //This variables are for the battleground system
    private int timer = 0;
    ...
    private boolean isInPowerFlightMode;
...
private boolean isInBattle = false;
	...
	public boolean isInInvasionRift() {
		return isInInvasionRift;
	}

	public void setInInvasionRift(boolean isInInvasionRift) {
		this.isInInvasionRift = isInInvasionRift;
	}
	...
	public void clearJoinRequest()
	{
	 ...
	 /**
     * @return Custom Scripts / FFA / ARENA / 2v2
    ...
    public boolean isInPowerFlight() {
        return isInPowerFlightMode;
    }

    public void setPowerFlight(boolean isInPowerFlightMode) {
        this.isInPowerFlightMode = isInPowerFlightMode;
    }
}
