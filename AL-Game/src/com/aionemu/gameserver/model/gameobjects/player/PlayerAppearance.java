...
public class PlayerAppearance implements Cloneable {
    ...
    private int eyeRGBRight; // 5.0
    private int pupilShape; // 5.0
    private int eyeLashes; // 5.0
    private int pupilSize; // 5.0
    private int upperTorso; // 5.0
    private int foreArmThick; // 5.0
    private int handSpan; // 5.0
    private int calfThick; // 5.0
    private int removeMane; // 5.0
    
    public int getEyeRGBRight() {
        return eyeRGBRight;
    }
    
    public void setEyeRGBRight(int eyeRGBRight) {
        this.eyeRGBRight = eyeRGBRight;
    }
    ...
    public int getForeArmThick() {
        return foreArmThick;
    }
    
    public void setForeArmThick(int foreArmThick) {
        this.foreArmThick = foreArmThick;
    }
    ...
    public int getCalfThick() {
        return calfThick;
    }
    
    public void setCalfThick(int calfThick) {
        this.calfThick = calfThick;
    }
     ...
     * Eye colour
     */
    public void setEyeRGBLeft(int eyeRGBLeft) {
        this.eyeRGBLeft = eyeRGBLeft;
    }

    /**
     * Sets eye colour
     */
    public int getEyeRGBLeft() {
        return eyeRGBLeft;
    }
