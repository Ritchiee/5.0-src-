...
public class ItemTemplate extends VisibleObjectTemplate {
    ...
    @XmlElement(name = "wing_stats")
    protected WingStats wingStats;
    ...
    @XmlElement(name = "bonus_skill")
    private BonusSkill bonus_skill;
    ...
    private static final WingStats emptyWingStats = new WingStats();
    @XmlTransient
    ...
    public final WingStats getWingStats() {
        return wingStats;
    }
    ...
    public BonusSkill getBonusSkill() {
        return bonus_skill;
    }
}
